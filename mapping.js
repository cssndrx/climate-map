const mapping = {
  ...
  "Biomass Power": [
    {
      "name": "XFuel",
      "employees": 17,
      "description": "XFuel produces sustainable and net-zero road, marine and aviation drop-in fuels for distributors and consumers. The company was founded in 2010 and is based in Palma de Mallorca, Baleares. XFuel has developed technology for sustainable and cost-effective conversion of biomass waste into a clean and drop-in advanced fuel for the transport sector. Fuel is produced efficiently, at low-cost and with currently up to 90% fewer GHGs than traditional fossil fuel production, with a clear route to achieving carbon negative fuels.",
      "website": "xfuel.com",
      "active_jobs": 2
    }
  ],
  ...
  "Building Automation Systems": [
    {
      "name": "SmartRent",
      "employees": 460,
      "description": "SmartRent is an enterprise home automation company developing software and hardware to help owners, property managers and renters in multifamily communities. SmartRent create multifamily technology solutions that provide property owners and managers a platform to better monitor and protect their assets, and create operational efficiencies all while driving ancillary revenue.",
    ...
    },
    {
      "name": "EnergyHub",
      "employees": 152,
      "description": "EnergyHub is the consumer face of the Smart Grid, helping home owners reduce energy consumption and save money. EnergyHub produces smart, simple, and cost-effective energy management tools that strengthen the relationship between consumers and utilities and solve the energy problems of today and tomorrow.",
    ...
    },
    {
      "name": "75F",
      "employees": 114,
      "description": "75F designs and manufactures the world\\'s leading IoT-based Building Management System, an out-of-the-box, vertically integrated solution that is more affordable and easier to deploy than anything on the market today. The company leverages IoT, Cloud Computing, AI and Machine Learning for data-driven, proactive building intelligence and controls for energy and comfort optimization. 75F\\'s mission is to improve comfort and indoor air quality \u2014 all while saving energy.",
      "website": "75f.io",
      "active_jobs": 10
    },
    {
      "name": "Runwise",
      "employees": 83,
      "description": "Runwise is a unique wireless control, sensor network, and software platform to operate heating systems better. Runwise is one of the nation\u2019s leading building control services. Runwise\u2019s mission is to enable buildings to run more efficiently using intelligent and easy-to-install wireless hardware and software. Runwise was started in 2010 by Jeff Carleton and Lee Hoffman.",
      "website": "runwise.com",
      "active_jobs": 5
    },
    {
    ...
    },
    {
      "name": "Ento Labs",
      "employees": 17,
      "description": "We help organisations increase energy efficiency and intelligent energy consumption to reduce emissions and support the sustainable energy transition with scalable, artificial intelligence software.",
      "website": "ento.ai",
      "active_jobs": 2
    },
    {
      "name": "Community Energy Labs",
      "employees": 13,
      "description": "Community Energy Labs\\' (CEL) mission is to simply & affordably enable communities\u2019 building decarbonization goals by 2030.\n\nCEL is an IoT & Software as a Service control platform for building operators who find it complex, frustrating and very expensive to meet new building energy goals using standard building control options. \n\n// Simple & intuitive\n// Single day installation\n// Autonomous control\n// Works with solar & battery",
      "website": "communityenergylabs.com",
      "active_jobs": 6
    },
    {
      "name": "Arbor",
      "employees": 12,
      "description": "Arbor is a digital energy platform for the modern consumer, making it easy for renters and homeowners to save on energy costs and live more sustainably. We monitor the energy market to automatically get you the best electric rate in your area and recommend the most relevant home electrification upgrades. Customers are saving on average $544 per year.",
      "website": "joinarbor.com",
      "active_jobs": 7
    },
    {
      "name": "Specifx Data",
      "employees": 10,
      "description": "Our proprietary technology delivers visibility, context, and insights into your entire HVAC asset portfolio \u2013 helping organizations understand and optimize their HVAC investments and carbon footprint at enterprise scale.",
      "website": "specifx.com",
      "active_jobs": 0
    }
  ],
  "Building Retrofitting": [
    ...
    },
    {
      "name": "Conduit Tech",
      "employees": 9,
      "description": "At Conduit Tech, we are using data to support HVAC Pros. We are passionate and optimistic builders who are iterating quickly to create products that solve the urgent pain points of our primary users.",
      "website": "getconduit.com",
      "active_jobs": 3
    },
    {
      "name": "Zero Homes",
    ...
    },
    {
      "name": "Arch",
      "employees": 7,
      "description": "Arch helps HVAC contractors grow their businesses and pioneer the future of home electrification. The Arch System of Intelligence streamlines lead generation, system design, and financing to increase conversion rates. Led by co-founders Phil Krinner and Sacha Schmitz, the San Francisco company brings together expertise in large-scale solar projects and advanced software development.",
      "website": "getarch.com",
      "active_jobs": 1
    },
    {
      "name": "EnergyRM",
      "employees": 5,
      "description": "EnergyRM is a clean energy fintech company that solves the split incentive in commercial buildings. Our Clean Energy Transaction Platform gives commercial building portfolios, project developers, and investors the tools they need to decarbonize buildings and generate new income from clean energy and energy efficiency investments.",
      "website": "energyrm.com",
      "active_jobs": 0
    },
    {
      "name": "Fram Energy",
  ...
  "Carbon Accounting": [
    {
      "name": "Wren",
      "employees": 413,
      "description": "Wren is a web app that helps live carbon neutral by accounting for and offsetting CO2 emissions. It aims to build tools that help everyone act against climate change. Starting with a subscription service has the added advantage of funding their future work. They believe the most effective way we can build a team to tackle this problem is to build a sustainable business. It was founded in 2019 and is headquartered in San Jose, California.",
    ...
    },
    {
      "name": "Patch",
      "employees": 107,
      "description": "Our planet is out of sync. Companies need to drastically lower their carbon footprint for us to reach our global climate goals. It\\'s time to reduce emissions as quickly as possible and neutralize anything remaining. Patch is the platform putting us on a path to a planet in balance.",
      "website": "patch.io",
      "active_jobs": 12
    },
    {
    ...
    },
    {
      "name": "Sustain.Life",
      "employees": 48,
      "description": "We\u2019re on a mission to empower organizations across the world to actualize the wide-ranging benefits of sustainability. How? By building a platform that makes it simple for organizations to reduce and manage their environmental impact. Behind Sustain.Life is a group of entrepreneurial operators that believe everyone has the responsibility\u2014and the opportunity\u2014to embrace sustainability. Having experienced firsthand the challenges that come with operationalizing sustainability in our personal lives, we set out to create an easier way to operationalize sustainability in our professional lives.",
    ...
    },
    {
      "name": "Joro",
      "employees": 34,
      "description": "Joro empowers people to take climate action that matters. Through an intuitive app, people can manage their carbon footprint based on how they spend money, develop a climate action practice, and build community to tackle the biggest crisis of our generation.",
      "website": "joro.tech",
      "active_jobs": 2
    },
    {
      ...
      "employees": 15,
      "description": "The essential software platform for carbon management, purpose-built for companies with complex supply chains.",
      "website": "gravityclimate.com",
      "active_jobs": 5
    },
    {
      "name": "Bend",
  ...
  "CCUS": [
    ...
    },
    {
      "name": "Running Tide",
      "employees": 126,
      "description": "Running Tide removes carbon through two pathways: Ocean alkalinity enhancement and biomass sinking.",
    ...
    },
    {
      "name": "Noya",
      "employees": 63,
      "description": "Noya\\'s mission is to accelerate the transition of industry to a sustainable existence. Every day, we\\'re making progress towards this mission with a CO2 capture process that utilizes existing industrial equipment to pull CO2 out of the air. Noya takes the CO2 pulled from the atmosphere and re-packages it for sale to industrial CO2 consumers. To achieve a future free of excess emissions, Noya is partnering with industrial equipment owners to deploy this carbon capture process onto their equipment. As the world\\'s only distributed direct air capture company, Noya will lead the reversal of climate change and the development of the technology that will ensure a long, fruitful existence for humans on Earth.",
      "website": "noya.co",
      "active_jobs": 1
    },
    {
    ...
    },
    {
      "name": "Arca",
      "employees": 19,
      "description": "We remove CO\u2082 from the atmosphere and transform it into rocks, for gigatonne-scale impact with an ultralight footprint.",
    ...
    },
    {
      "name": "Carbon Reform",
      "employees": 11,
      "description": "Carbon Reform is designing the Carbon Capsule, a modular carbon dioxide capture device that helps eco- and health-conscious building owners reduce CO2 and contaminant levels internally, while saving energy on heating and cooling.",
    ...
    },
    {
      ...
      "employees": 9,
      "description": "CO280 aims to help businesses reduce their carbon footprint by developing permanent, high quality, carbon negative solutions. In collaboration with its partners, CO280 utilizes experience and skills to develop, finance and implement complex carbon dioxide removal.",
      "website": "co280.com",
      "active_jobs": 2
    },
    {
  ...
  "Clean Cooking": [
    ...
    {
      "name": "Channing Street Copper Company",
      "employees": 12,
      "description": "Channing Street Copper Company provides Energy Storage Equipped (ESE) appliances such as induction cookers. The company offers an induction cooker that uses electricity to directly heat the pan and it\\'s an electric range that works during a power outage. Channing Street Copper Company was founded in 2022 and is headquartered in Berkeley, CA.",
      "website": "channingcopper.com",
      "active_jobs": 0
    }
  ],
  "Climate Finance": [
    ...
    },
    {
      ...
      "website": "https://opna.earth/",
      "active_jobs": 5
    },
    {
      "name": "GoodLynx",
      "employees": 1,
      "description": "GoodLynx is a climate technology company on a mission to accelerate the energy transition. We\u2019re creating the digital interconnect that links clean energy developers with: Energy Tax Credit Buyers; Financing and Step-up Investors; Standardized Insurance Solutions; Compliance Management; Environmental Attributes.",
      "website": "goodlynx.com",
      "active_jobs": 0
    },
    {
      "name": "Eli",
  ...
  "Climate Intelligence": [
    ...
    },
    {
      "name": "Albedo",
      "employees": 45,
      "description": "At Albedo, we believe that space is more than just a place to explore \u2014 it\u2019s also a tool that can be used to help tackle problems here on Earth. Our exquisite imagery empowers industry leaders with the details that matter so that we can support what we have and shape what we don\u2019t.",
  ...
  "Climate Risk": [
    ...
    },
    {
      "name": "Cervest",
      "employees": 19,
      "description": "Cervest is an AI powered climate intelligence platform to quantify asset-level risk globally. Since 2016 it has been pioneering \u2018Earth Science AI\u2019 to automatically quantify and standardize asset-level climate risk for millions of global assets, with a focus on the built environment. We believe that everyone deserves Climate Security - we offer users open, shared, and independent tools to proactively manage \u2018asset-level\u2019 climate security, offering science-backed and quantified analysis of climatic extreme events on physical assets globally. Proven team from Silicon Valley and EU \u2013 previously with Google, Amazon, Benevolent AI, Shell, and Microsoft. Research partnerships with Alan Turing Institute, Imperial College and Oxford University. Team includes world-renowned sector experts, scientists and engineers. We\\'re mission-focused (B-Corp) and based in London - backed by mission aligned investors including Astanor Ventures, Future Positive Capital, Lionheart Ventures, and Lowercarbon Capital.",
      "website": "cervest.earth",
      "active_jobs": 0
    },
    {
  ...
  "Distributed Energy Storage": [
    {
      ...
      "employees": 412,
      "description": "Our Next Energy is a Michigan-based developer of innovative energy storage solutions with a vision to rapidly expand the world\\'s access to sustainable power.",
      "website": "one.ai",
      "active_jobs": 0
    },
    {
    ...
    },
    {
      "name": "Moxion Power",
      "employees": 250,
      "description": "Moxion Power develops zero-emission generators and off-road equipment to support industries. Moxion Power offers temporary mobile power units which run on electric power for charging and coupled with automatic swapping functionality, enabling clients from the construction industry, events and entertainment, utilities, EV fleet operators, andgovernment agencies to get their temporary energy needs met in an eco-friendly manner.",
      "website": "moxionpower.com",
      "active_jobs": 30
    },
    {
      "name": "FreeWire Technologies",
      "employees": 221,
      "description": "FreeWire Technologies provides smart battery systems for EV charging and mobile distributed power. It provides clean, quiet mobile power, and fast charging that\u2019s available and easy to deploy. The company\\'s products deliver power wherever and whenever users need it, without the added costs of construction or infrastructure upgrades. The company merges designs with convenient services to electrify industries formerly dependent on fossil fuels. FreeWire customers can tackle new applications and execute new business models without the complexity of upgrading traditional energy infrastructure. It also creates beautifully designed products and convenient services to electrify industries formerly dependent on fossil fuels. Their comprehensive solutions provide energy delivery and management that customers can rely on every day. The company is backed by venture capital firms and global fortune 500 companies. FreeWire Technologies was founded in 2014 and is headquartered in San Leandro, California.",
    ...
    },
    {
      "name": "Instagrid",
      "employees": 131,
      "description": "Instagrid creates software-defined battery systems for advanced portable power supplies.",
      "website": "instagrid.co",
      "active_jobs": 60
    },
    {
      "name": "TWAICE",
      "employees": 127,
      "description": "TWAICE provides predictive analytics software that optimizes the development and operation of lithium-ion batteries. TWAICE\u2019s core technology is the digital twin - a software that combines deep battery knowledge and artificial intelligence to determine the condition and predict the aging and performance of batteries. This makes complex battery systems more transparent, effective and reliable. As the leading battery analytics software for global players in the mobility and energy sectors, TWAICE is committed to increasing the lifetime, efficiency and sustainability of the products that power the economy of tomorrow. Find out more at www.twaice.com",
      "website": "twaice.com",
      "active_jobs": 3
    },
    {
      "name": "Liminal",
      "employees": 76,
      "description": "Liminal is a battery manufacturing intelligence provider that combines ultrasound technology with machine learning to deliver advanced insights that empower manufacturers.",
      "website": "liminalinsights.com",
      "active_jobs": 0
    },
    {
      "name": "Holy Grail",
      "employees": 56,
      "description": "Holy Grail develops energy storage and battery technology that uses electrons to capture carbon dioxide from the atmosphere. It leverages AI and is involved in the research, development, and engineering of various products like batteries, catalysts, and materials datasets which can be used to cross-validate predictions and simulations of experimental data, enabling industrial clients to ensure and benefit from energy efficiency and economy.",
    ...
    },
    {
      "name": "Zitara",
      "employees": 39,
      "description": "Zitara builds battery management software for enterprises with large deployments. It was founded in 2019 and is headquartered in Oakland, California.",
      "website": "zitara.io",
      "active_jobs": 13
    },
    {
      "name": "Moment Energy",
      "employees": 35,
      "description": "Moment Energy creates commercial-scale, sustainable energy storage solutions (ESS) from repurposed electric vehicle (EV) batteries. Our ESS helps you achieve your energy and sustainability goals. By using an ESS, you will reduce energy costs, replace fossil fuels, and facilitate the adoption of renewables. The system comes in 48kWh building blocks stackable up to 1MWh. Moment Energy\\'s solution has various applications. Commercial and industrial facilities and EV charging networks can significantly reduce utility demand charges by pairing Moment Energy\\'s ESS with an inverter, which levels out peaks in electricity use. Additionally, our systems are a cost-effective alternative to upgrading power infrastructure on EV charging networks. Our ESS delivers performance similar to new lithium-ion batteries at a fraction of the cost.",
      "website": "momentenergy.com",
      "active_jobs": 2
    },
    {
      "name": "Blue Planet Energy Systems, LLC",
      "employees": 21,
      "description": "Blue Planet Energy, founded in 2015 by the entrepreneur behind the video game Tetris, is replacing the decaying electrical grid with a distributed model that empowers residential and business customers to be energy independent while accelerating renewable energy adoption. Our scalable energy platform, Blue Ion, combines a best-in-class battery with superior safety (no fire risk) and longer lifetime with sophisticated software controls to create smart, flexible microgrids. Our strong track record of delivering premium products along with excellent service and support has accelerated our growth in recent years. Our products are adopted widely in off-grid and grid edge markets across North America. We recently completed supplying the largest energy resilience project in the US for the American Red Cross, which includes over 6MW of solar and 11 MWh of Blue Ion energy storage across 110 microgrids in Puerto Rico.",
    ...
    },
    {
      "name": "Imprint Energy",
      "employees": 13,
      "description": "Imprint Energy is commercializing a breakthrough low cost, flexible, rechargeable battery technology that will change portable power as the world knows it. Imprint aims to provide batteries with lithium-like performance at significantly lower costs and without form factor limitations or safety concerns. Imprint Energy will utilize its unique battery technology to address the energy needs of today\\'s and tomorrow\\'s electronic devices.",
      "website": "imprintenergy.com",
      "active_jobs": 8
    }
  ],
  "Distributed Solar Photovoltaics": [
    ...
    },
    {
      "name": "Nnergix",
      "employees": 25,
      "description": "Nnergix collects weather and energy data from multiple sources from the industry in order to feed owned machine learning based algorithms to run several analytic solutions with the main goal to help any player in the field to be more efficient during operations and reduce costs.",
      "website": "nnergix.com",
      "active_jobs": 0
    },
    {
  ...
  "Efficient Aviation": [
    ...
    },
    {
      "name": "ZeroAvia",
      "employees": 272,
      "description": "ZeroAvia builds a practical zero-emission aviation powertrain, based on electric propulsion powered by the hydrogen fuel cell system. Initially focusing on 500-mile zero-emission travel in a 10-20 seat regional aircraft, the company\\'s unique approach results in 4x lower fuel and engine maintenance costs. The company was founded in 2017 by Val Miftakhov and is based in Hollister, California, United States.",
    ...
    },
    {
      ...
      "employees": 213,
      "description": "Heart\u2019s mission is to create the fastest, most affordable and sustainable transportation for regional travel to every corner of the world. Their first aircraft is the ES-19, a nineteen-passenger airliner with an operating range of 400 km. Heart\\'s goal is to have the aircraft certified for commercial operation by 2026.",
    ...
    },
    {
      "name": "XWING",
      "employees": 90,
      "description": "Xwing develops the suite of technologies necessary for the pilotless flight of small passenger aircraft. Based in the heart of San Francisco, Xwing is a VC-backed company assembling world-class engineering talent from the aerospace and software industries.",
      "website": "xwing.com",
      "active_jobs": 1
    },
    {
      ...
      "employees": 86,
      "description": "Universal Hydrogen is dedicated to making hydrogen aviation a near-term reality. The company is building a hydrogen ecosystem for aviation through strategic partnerships and new technologies for hydrogen distribution and propulsion.",
    ...
    },
    {
      "name": "Ampaire",
      "employees": 38,
      "description": "The Third Revolution in Aviation has begun and Ampaire is leading the charge by developing aircraft that make flying clean, quiet, safe, reliable, affordable, and more accessible to more people than ever before. With key innovations in energy storage, propulsion, and aircraft architecture, the Ampaire team is maximizing the potential of theaircraft industry. Ampaire is a portfolio company of the Los Angeles Cleantech Incubator. It was founded in year 2016 and is based in Los Angeles, California.",
      "website": "ampaire.com",
      "active_jobs": 2
    },
    {
    ...
    },
    {
      "name": "Camp Six Labs",
      "employees": 7,
      "description": "Camp Six is developing an aerial freight transportation network. Powered by unmanned aircraft designed to deliver 1,000lbs of payload 1,000 miles away, we believe better transportation will boost lives in every remote corner of the globe.",
      "website": "campsix.com",
      "active_jobs": 0
    },
    {
      ...
      "employees": 1,
      "description": "Astro Mechanica develops aircraft for a new kind of air travel, making the convenience of private air travel possible at airline prices. Scaling the efficiencies of airline-class aircraft down to a private size enables a new, more distributed means of long range air travel.",
      "website": "astromecha.co",
      "active_jobs": 0
    }
  ],
  "Efficient Ocean Shipping": [
    ...
    },
    {
      "name": "Seabound",
      "employees": 9,
      "description": "Shipping accounts for 3% of global CO2 emissions, but has limited existing solutions to decarbonize. Alternative power sources such as hydrogen, ammonia, and batteries are still 10-20 years away from being feasible for large cargo ships. Seabound is piloting patent-pending technology that captures CO2 from the ship\\'s exhaust gas using lime (CaO). We\\'re developing the only way for shipowners to reduce up to 95% of their CO2 emissions and comply with upcoming global regulations.",
      "website": "seabound.co",
      "active_jobs": 6
    },
    {
    ...
    },
    {
      "name": "Fleet Robotics",
      "employees": 1,
      "description": "Formerly Bluetech Robotics. Introducing a flexible, hands-off solution for proactive hull cleaning.",
      "website": "fleetrobotics.ai",
      "active_jobs": 2
    }
  ],
  "Efficient Trucks": [
  ...
  "Electric Cars": [
    ...
    },
    {
      "name": "SparkCharge",
      "employees": 70,
      "description": "Developer of portable charging units intended to revolutionize the electric vehicle industry. The company\\'s product permits users to charge their car in under five minutes and gives them the option to choose how much portable battery range they want to take with them, enabling electric vehicle owners to charge their car anywhere they want and whenever they want.",
    ...
    {
      "name": "Electric Era Technologies",
      "employees": 24,
      "description": "Electric Era Technologies develops AI-controlled battery storage for the cost-effective operation of charging stations. Its family of solutions is powered by PowerNode-OS, a real-time software platform that brings optimized and reliable charging to every PowerNode charging station.",
      "website": "electriceratechnologies.com",
      "active_jobs": 3
    },
    {
      "name": "Greenlots",
    ...
    },
    {
      "name": "Powerline",
      "employees": 21,
      "description": "Drive Powerline, Inc. (pka, gigElev) provides artificial intelligence solutions to connect electric vehicles (EVs) on the road to optimized charging and V2X services on the grid.",
      "website": "drivepowerline.com",
      "active_jobs": 0
    },
    {
    ...
    },
    {
      "name": "Plug",
      "employees": 8,
      "description": "EV Wholesale Auctions",
      "website": "plug.vin",
      "active_jobs": 2
    },
    {
    ...
    },
    {
      "name": "Presto",
      "employees": 4,
      "description": "Presto\u2019s software platform simplifies the charging experience for fleets, mobility providers, and businesses by enabling drivers to find, start, and pay for charging on any of its partner networks all on the Presto app.",
  ...
  "Electric Grid": [
    ...
    },
    {
      "name": "VEIR",
      "employees": 41,
      "description": "VEIR is developing a new generation of High Temperature Superconductor (HTS)-based transmission lines. VEIR\u2019s evaporative cooling architecture delivers 20 times the cooling power per kilogram of coolant flow compared to conventional approaches. VEIR\u2019s innovations will enable reliable, low loss, cost\u2013effective HTS-based transmission over long distances in narrow rights\u2013of\u2013way, connecting the lowest cost renewable power to where it\u2019s needed, when it\u2019s needed.",
      "website": "veir.com",
      "active_jobs": 8
    },
    {
    ...
    },
    {
      "name": "TS Conductor",
      "employees": 32,
      "description": "TS Conductor is a technology that replaces legacy materials in high-voltage electricity transmission lines with a next-generation conductor that doubles the lines\\' capacity without the need to retrofit towers or other infrastructure.",
      "website": "tsconductor.com",
      "active_jobs": 0
    },
    {
  ...
  "ESG": [
    ...
    },
    {
      "name": "Optera",
      "employees": 61,
      "description": "Optera\\'s software, Flagstaff RPO, is the first SaaS platform designed to enable companies to manage emissions, energy, water, and waste across their operations and supply chains in accordance with climate science.",
    ...
    },
    {
      "name": "Climate Club",
      "employees": 22,
      "description": "We work with companies to embed sustainability into the employee experience through role-relevant data, tools and resources. We enable companies to convert Net Zero plans into action, and deliver measurable outcomes at the employee, team, department and company level that save on carbon and costs. Let\\'s connect to see if Climate Club is right for you and your company.",
      "website": "climateclub.com",
      "active_jobs": 0
    },
    {
      "name": "Verse Inc.",
      "employees": 17,
      "description": "Whether you\u2019re an experienced buyer of clean energy or just setting sustainability goals, Verse\u2019s Aria\u2122 software saves you time and money.",
      "website": "verse.inc",
      "active_jobs": 1
    },
    {
    ...
    },
    {
      "name": "Clarasight",
      "employees": 1,
      "description": "Forward-looking organizations use Clarasight to analyze, forecast, and build agile carbon emissions reduction plans when business and carbon goals coexist.",
      "website": "clarasight.com",
      "active_jobs": 0
    }
  ],
  "Geoengineering": [
  ...
  "Green Hydrogen": [
    ...
    },
    {
      "name": "H2Pro",
      "employees": 105,
      "description": "H2Pro is on a mission to enable affordable green hydrogen at scale by providing the world with the leading next generation electrolyzer. H2Pro\u2019s E-TAC electrolyzer is a revolutionary system for producing green hydrogen by splitting water at 95% energy efficiency (compared to 60-70% efficiency of conventional systems). This breakthrough efficiency combined with E-TAC\\'s reduced cost of materials, easily scalable membraneless design, and high compatibility with renewables will allow H2Pro systems to deliver the lowest Levelized Cost of Hydrogen (LCOH). In order to reach net zero, green hydrogen must be integrated into hard-to-abate sectors, such as steel, ammonia, refineries, heavy transport and aviation. It will also serve a critical role in energy storage and as a green molecule for renewable energy export. H2Pro is committed to accelerating the widespread adoption of this vital decarbonization tool by making it economically viable by the end of this decade. Headquartered in Caesarea, Israel, H2Pro was founded in 2019 based on years of research conducted at the Technion, Israel Institute of Technology. H2Pro has raised over 100 Million USD. It is backed by leading investors and strategic partners, including Bill Gates-founded Breakthrough Energy Ventures, Temasek Holdings, Horizons Ventures, ArcelorMittal, Yara Growth Ventures, OurCrowd, COPEC, Hyundai, Sumitomo Corporation, Extantia, Bazan, Doral and New Fortress Energy. Today, we are a team of over 100 people, with branches in Germany, Spain, and the U.S., working every day to make green hydrogen affordable at scale. The future of our planet may depend on it.",
      "website": "h2pro.co",
      "active_jobs": 7
    },
    {
  ...
  "Green Steel": [
    {
      "name": "ElectraSteel",
      "employees": 67,
      "description": "ElectraSteel uses intermittent renewable energy for the electrification and decarbonization of iron and steelmaking. ElectraSteel\\'s investors include leading sustainability-focused global venture capital funds with $300B+ assets under management.",
      "website": "electrasteel.com",
      "active_jobs": 14
    }
  ],
  "Grid Flexibility": [
    {
      "name": "Arcadia",
      "employees": 623,
      "description": "Arcadia is a climate technology company enabling a zero-carbon economy. By unlocking high-fidelity, global energy data for the first time, the Arc platform combines easy-to-use data and APIs under one roof to allow any company to act on its environmental impact and build the next generation of energy products and climate tech solutions. Arc democratizes access to data from thousands of utility providers in over 50 countries, covering more than 95% of US utility accounts. Founded in 2014 on the belief that everyone deserves access to clean energy, Arcadia also manages the nation\u2019s leading community solar program, helping to tackle energy injustice while spurring economic growth with more than 2 GW of solar under management.",
      "website": "arcadia.com",
      "active_jobs": 10
    },
    {
    ...
    },
    {
      "name": "Ohmconnect",
      "employees": 92,
      "description": "Ohmconnect provides home energy management solutions via smart meter analytics and energy market integration. Our innovative platform enables residential users to sell their energy reductions directly into energy markets via \"demand response.\"\u200b",
    ...
    },
    {
      "name": "GridX",
      "employees": 76,
      "description": "GridX, Inc. develops software that solves back office information technology (IT) challenges utilities are facing as a result of smart grid and smart meter deployment. The company was founded in 2010 and is based in Sunnyvale, California.",
      "website": "gridx.com",
      "active_jobs": 5
    },
    {
      ...
      "employees": 59,
      "description": "Blueprint Power is an NYC-based tech company whose mission is to accelerate the growth and financial sustainability of distributed, intelligent clean energy by helping regional groups of real estate companies transform their portfolios into power plants. More specifically, they manage these power plants to generate excess supply that they can then sell to markets and customers who increasingly need a more and higher quality supply of electricity. Blueprint is founded by experienced tech innovators and entrepreneurs from firms like Google, Boeing, and Vestas, and are backed by prominent corporate leaders and venture investors from the worlds of real estate, energy, and tech.",
      "website": "blueprintpower.com",
      "active_jobs": 2
    },
    {
      "name": "Reactive Technologies",
      "employees": 58,
      "description": "Reactive Technologies we are committed to enabling a more intelligent use of energy, for the largest and most complex business to the smallest household. Our aim is to develop new technologies that will positively assist the energy industry to deliver cleaner, greener and more affordable energy, through more efficient and effective energy management and control. Through our innovative, cloud-based solution for Corporate customers \u2013 Tradenergy \u2013 we have begun this process and with our pipeline of ground breaking new technologies we intend to continue.",
      "website": "reactive-technologies.com",
      "active_jobs": 0
    },
    {
      "name": "Amperon",
      "employees": 55,
      "description": "Amperon is a provider of smart meters to deliver real-time energy data forecasts. There over 70M smart meters currently installed in the country, collecting 15 minute resolution electricity data for every type of ratepayer (including residential, commercial, and industrial). The data has been relatively untapped for the past decade, and Amperon is leveraging it to charge forward and bring AI to the energy world to usher in the smart grid of the future.",
      "website": "amperon.co",
      "active_jobs": 8
    },
    {
      "name": "Innowatts",
      "employees": 53,
      "description": "Innowatts is a data analytics and energy transition leader who uses energy usage data, insights and best-in-class machine learning to help energy retailers and utilities from around the world manage their grids, profitability, customer relationships and sustainability goals in a digitalizing, decarbonizing, and electrifying world. To date, the Innowatts eUtility technology platform has leveraged data from more than 34 million meters to help energy providers ensure grid reliability, anticipate trends, secure profitability, and promote sustainability \u2014 advancing and creating a more personalized energy experience for their customers. For more information, please visit www.innowatts.com.",
      "website": "innowatts.com",
      "active_jobs": 5
    },
    {
      "name": "David Energy",
      "employees": 50,
      "description": "David Energy is a new kind of retail electricity provider. Energy is complicated. That\u2019s where we come in. We\u2019re a new kind of retail electricity supplier\u2014vertically integrated and powered by technology. We bring electricity supply and demand response together to keep things simple and to save you money on your bill.",
    ...
    },
    {
      "name": "Enode",
      "employees": 37,
      "description": "Enode develops APIs that connect EVs, solar, batteries, and heating to energy consumer products. Once connected, the digital infrastructures SaaS-based platform integrate them into the app to optimize energy consumption and help to participate in flexible markets with connected hardware, enabling clients to facilitate a zero-carbon energy grid. The Oslo, Oslo, Norway-based company was established in 2020 by Henrik Langeland, Nikolai Heum, and Thorvald Thorsnes.",
      "website": "enode.io",
      "active_jobs": 9
    },
    {
      "name": "Ostrom",
      "employees": 29,
      "description": "Ostrom is a Certified B Corp\u2122 digital energy management platform based in Berlin that makes green electricity affordable and straightforward for households in Germany. Unlike other traditional providers with lengthy contracts, Ostrom offers monthly tariffs, end-to-end English and German support, and electricity at market purchase price, which comes from 100 percent renewable energy sources. Consumers can view their energy consumption and control their tariff in real time using the Ostrom app. In 2023, Ostrom rolled out dynamic pricing and electric vehicle charging integration and its roadmap includes incorporating smart meters and more. All this will support Ostrom in becoming the leading B2C energy platform in Europe by 2030.",
      "website": "ostrom.de",
      "active_jobs": 0
    },
    {
    ...
    },
    {
      "name": "ElectricFish",
      "employees": 14,
      "description": "At 3% EV penetration, US electricity grid is overwhelmed by charging loads, and with climate change adding further strain, power outages are growing. We are building a network of storage devices that can also charge cars during normal hours but store energy for outages.",
      "website": "electricfish.co",
      "active_jobs": 0
    },
    {
    ...
    },
    {
      "name": "Tyba",
      "employees": 9,
      "description": "Tyba provides end-to-end modeling for the optimal design and operation of standalone and hybrid energy storage systems. Their flexible platform lets developers understand where and how to build, investors value storage assets more confidently, and operators forecast and capture value on a daily basis.",
      "website": "tyba.ai",
      "active_jobs": 0
    },
    {
      "name": "InRange",
      "employees": 8,
      "description": "InRange is an enterprise electricity provider. Creating a new C&I energy supply business model out of the built environment. We\u2019re on a mission to create reliable local carbon free energy at scale so that our local grids become 100% renewable. We bring electricity supply and demand response together to keep things simple and to save you money on your bill. We understand that for leading energy buyers, governments and suppliers it\u2019s essential to focus on hourly decarbonization of local and regional electricity grids.",
      "website": "inrange.io",
      "active_jobs": 0
    },
    {
    ...
    {
      "name": "Resilient Power Systems",
      "employees": 6,
      "description": "Created a new type of power converter that can route power like data. This patented technology serves as a reusable platform for ultra-compact and affordable power electronics that reduce the cost of EV chargers, HVDC converters, STATCOMs, and solar/wind inverters. These products are all built on our power electronic building block (PEBB), which can be reconfigured with software into many different devices with advantages of economy of scale and reduced engineering effort.",
      "website": "resilientpower.com",
      "active_jobs": 0
    }
  ],
  ...
  "Improved Aquaculture": [
    {
      "name": "Reel Foods",
      "employees": 4,
      "description": "We\u2019re on a mission to create delicious, flaky, cultivated fish fillets indistinguishable from the fish you know and love.",
      "website": "reelfoods.co",
      "active_jobs": 0
    }
  ],
  "Improved Cattle Feed": [
    ...
    },
    {
      "name": "Fyto",
      "employees": 21,
      "description": "Fyto leverages automation to unlock the potential of unique aquatic plants. We partner with farmers to build a new foundation for food, feed, and fertilizer that supports a healthy planet and resilient food system. Our automated cultivation and harvesting technologies grow highly nutritious crops at scale, which drastically reduce input costs for food producers.",
      "website": "fyto.us",
      "active_jobs": 2
    },
    {
  ...
  "Macroalgae Protection and Restoration": [
    {
      "name": "Phycobloom",
      "employees": 10,
      "description": "Phycobloom is using synthetic biology to create novel strains of algae that will use atmospheric CO2 to create affordable and sustainable hydrocarbons. Phycobloom\u2019s founders are Dr. Ian Hu, who has been genetically engineering algae for a decade, and Dr. John Waite, with a background in materials science and a passion for creating the sustainable energy systems of the future.",
      "website": "phycobloom.com",
      "active_jobs": 0
    },
    {
      "name": "Macro Oceans",
      "employees": 7,
      "description": "Macro Oceans was founded to harness the restorative power of seaweed. This zero-input crop can be transformed into a wide array of green products while also offering significant environmental benefits. Macro Oceans is developing the technology to accelerate the transition to a cleaner bio-based economy and help to restore the vitality of our oceans.",
      "website": "macro-oceans.com",
      "active_jobs": 0
    }
  ],
  "Managed Grazing": [
  ...
  "Micro Wind Turbines": [
    {
      "name": "Amber Kinetics",
      "employees": 30,
      "description": "Amber Kinetics is a low cost flywheel energy storage system, developing a flywheel system from sub-scale research prototype to full-scale mechanical flywheel battery and will conduct both a commercial-scale and a utility-scale demonstration. Amber Kinetics\u2019 aim is to deliver a cost-effective prototype flywheel system that can be grid connected and electrically charged and discharged. The system has built-in sensing components that determines frequency and voltage characteristics of the grid and overrides the grid signal to manage the amount of electricity discharged. Amber Kinetics\u2019 flywheel stores energy in a spinning rotor that is connected to an electric motor that converts electrical energy into mechanical energy. To recover the energy the motor is electrically reversed and used as a generator to slow down the flywheel converting the mechanical energy back into electrical energy. Amber Kinetics improves the traditional flywheel system by engineering breakthroughs in three areas, magnetic bearings, low-cost rotor, and high-efficiency motor generator. Its technology can also be used to optimize existing infrastructure. Amber Kinetics was founded by [Seth Sanders](https://www.crunchbase.com/person/seth-sanders-2). It is based in California City, California.",
  ...
  "Nutrient Management": [
    ...
    },
    {
      "name": "Nitricity",
      "employees": 28,
      "description": "Nitricity is an energy company that is currently developing a system to produce carbon-free fertilizer. Its technology can produce ready-to-use nitrogen with only air, water, and renewable electricity. We produce both nitric acid and ammonia, which can be used separately or combined to produce ammonium nitrate fertilizer.",
      "website": "nitricity.co",
      "active_jobs": 6
    }
  ],
  "Ocean Power": [
  ...
  "Plant-Rich Diets": [
    ...
    },
    {
      "name": "Phytoform Labs",
      "employees": 24,
      "description": "Phytoform Labs is a biotechnology company which aims to help breeders to cut down plant breeding times from decades to years using new gene editing technologies. Predictably evolving plants will maximise yields for breeders and improve the economics of breeding for customers.",
      "website": "phytoformlabs.com",
      "active_jobs": 1
    },
    {
      "name": "Heartee Foods",
      "employees": 23,
      "description": "Heartee offers to grow gourmet mushrooms in solar-powered container farms offering fourteen different types of mushrooms.",
      "website": "hearteefoods.com",
      "active_jobs": 0
    },
    {
      "name": "Coconut Bliss",
  ...
  "Public Transit": [
    ...
    },
    {
      ...
      "employees": 31,
      "description": "WhereIsMyTransport is an operator of a mobility technology company intended to be the de facto source of mobility data for low and middle-income cities. The company operates a data collection playbook for mapping formal and informal public transport networks in emerging-market cities, providing businesses, cities, and citizens with the information they need to enter new markets, improve infrastructure and get where they need to go.",
  ...
  "Recycled Metals": [
    {
      ...
      "employees": 520,
      "description": "Redwood is developing a fully closed-loop, domestic supply chain for lithium-ion batteries. Our team manufactures critical battery components using as many recycled batteries as possible \u2014 localizing a 50,000-mile global supply battery chain on a single site.",
    ...
    },
    {
      "name": "Li-Cycle",
      "employees": 389,
      "description": "Li-Cycle is a clean technology company with revolutionary technology for resource recovery of end-of-life lithium-ion batteries. Li-Cycle Technology is a closed loop, economically viable, safe and sustainable process that can recover 80 \u2013 100% of all materials in lithium-ion batteries. Li-Cycle is on a mission to provide sustainable and safe customer-centric solutions for end-of-lifecycle lithium ion batteries while meeting the rapidly growing demand for critical battery.",
    ...
    },
    {
      ...
      "employees": 236,
      "description": "Lilac Solutions has developed a new ion exchange technology to address the challenges faced by lithium producers. Lilac\\'s technology cuts capital and operating costs, accelerates project startup, boosts lithium recovery, and unlocks new resources. Their process is modular and can be ramped up quickly through pilot and commercial projects. Lilac is a mining technology company and is building partnerships with brine developers and operators around the world.",
      "website": "lilacsolutions.com",
      "active_jobs": 5
    },
    {
      "name": "Phoenix Tailings",
      "employees": 43,
      "description": "Phoenix Tailings (Techstars Boston 2020) was founded to be the world\\'s first fully clean mining and metals production company. By harvesting the value held within mining waste, Phoenix Tailings creates zero carbon emission metals including rare earth metals, iron, PGMs, and pigments.",
    ...
    },
    {
      "name": "Sortera Alloys",
      "employees": 39,
      "description": "Sortera Alloys manufactures low-cost, high-quality metal alloys for domestic manufacturing using its artificial intelligence technology. Sortera Alloys is a company based in Fort Wayne, Indiana, and was established in 2020.",
      "website": "sorteraalloys.com",
      "active_jobs": 10
    },
    {
      "name": "Nth Cycle",
      "employees": 37,
      "description": "Nth Cycle is a metal refining company. We work with scrap recyclers and miners to recover production-grade critical metals from industrial scrap, low-grade ore, and refining waste. Our patented electro-extraction technology, The Oyster \u2014 an alternative to hydrometallurgy and pyrometallurgy \u2014 enables customizable, clean, and consistent recovery of the critical metals for the energy transition.",
      "website": "nthcycle.com",
      "active_jobs": 0
    },
    {
    ...
    },
    {
      "name": "Genomines",
      "employees": 27,
      "description": "We are Genomines. We genetically enhance metal hyperaccumulator plants to produce bio-sourced metals and limit the environmental impact of mining groups.",
      "website": "genomines.com",
      "active_jobs": 9
    },
    {
      "name": "Novalith Technologies",
      "employees": 24,
      "description": "Novalith Technologies is a climate technology company that uses carbon dioxide to simplify lithium chemicals production. Novalith\\'s LiCALTM lithium extraction technology uses significantly less equipment, chemical reagents, water and energy than conventional processing, which reduces capital and production costs. The direct use and sequestration of CO2 in producing lithium chemicals also produces a much smaller emissions footprint than existing and alternative processes.",
      "website": "novalith.com.au",
      "active_jobs": 1
    },
    {
      "name": "Magrathea",
      "employees": 15,
      "description": "Developing a new generation of electrolytic technology for making carbon neutral magnesium metal from seawater and brines for the era of electrification and decarbonization.",
      "website": "magratheametals.com",
      "active_jobs": 10
    },
    {
      "name": "SiTration",
      "employees": 14,
      "description": "SiTration\u2019s silicon membrane enables ultra-efficient separations in the most demanding environments. Our technology is being deployed with commercial partners in the mining and Li-ion battery recycling industries to unlock low-cost and sustainable recovery of critical materials such as lithium, cobalt, nickel, and copper.",
      "website": "sitration.com",
      "active_jobs": 1
    },
    {
      "name": "Lithios",
      "employees": 8,
      "description": "Lithios is a technology company using breakthroughs in applied electrochemistry for advanced lithium extraction from tough mixtures. We are reimagining lithium extraction for an electric future.",
      "website": "lithios.xyz",
      "active_jobs": 0
    },
    {
  ...
  "Reduced Food Waste": [
    ...
    },
    {
      "name": "Full Harvest",
      "employees": 60,
      "description": "At Full Harvest, our vision is a world where there is 0% food waste and 100% \\'full harvests\\', where all edible produce grown goes towards consumption. We aim to reinvent the produce supply chain with technology to bring the industry online for the first time ever and maximize resources.",
      "website": "fullharvest.com",
      "active_jobs": 4
    },
    {
      "name": "Shelf Engine",
      "employees": 59,
      "description": "Shelf Engine is a provider of an automated prediction engine that recommends what to order every day. It is transforming the food supply chain by helping grocery stores increase profit margins while drastically reducing food and beverage waste. Using machine learning, Shelf Engine forecasts demand for highly perishable foods, reducing waste and out-of-stocks. Shelf Engine\\'s unique business model handles the entire ordering process from vendor management to shelf optimization, saving retailers money and reducing risk by buying back any remaining unsold items. Launched in 2015, Seattle-based Shelf Engine has more than 145 employees and manages orders for leading grocers at thousands of locations nationwide.",
      "website": "shelfengine.com",
      "active_jobs": 0
    },
    {
      "name": "Consentio",
      "employees": 41,
      "description": "is an end-to-end food supply chain transaction platform. Their marketplace aims at improving ordering efficiency for all the players of the food supply chain - producers, cooperatives, whole sellers, and supermarkets - meaning less food waste and greater levels of transparency.",
      "website": "consentio.co",
      "active_jobs": 1
    },
    {
      "name": "Goodr",
      "employees": 38,
      "description": "A sustainable food waste management company leveraging technology to fight waste and hunger",
      "website": "goodr.co",
      "active_jobs": 0
    },
    {
    ...
    },
    {
      ...
      "employees": 30,
      "description": "Clean Crop Technologies is translating groundbreaking research on ways to reduce molds, toxins, and pests into commercial scale services for the global grain and nut sectors.",
      "website": "cleancroptech.com",
      "active_jobs": 8
    }
  ],
  "Reduced Plastics": [
  ...
  "Sustainable Intensification for Smallholders": [
    ...
    {
      "name": "Farm Link Hawai\u2018i",
      "employees": 15,
      "description": "Farm Link Hawai\u2018i is an online local food marketplace and delivery service helping O\u02bbahu consumers conveniently access the highest quality food produced across the state. Our mission is to create a thriving, equitable local food system by empowering local farmers and improving access to local foods.",
      "website": "farmlinkhawaii.com",
      "active_jobs": 0
    },
    {
      "name": "Hawaii'i 'Ulu Cooperative",
      "employees": 10,
      "description": "Hawaii\\'i \\'Ulu Cooperative\\'s crops are grown sustainably on small family farms by over 100 cooperative member farmers.",
      "website": "eatbreadfruit.com",
      "active_jobs": 1
    }
  ],
  ...
  "Utility-Scale Energy Storage": [
    {
      "name": "Form Energy",
      "employees": 559,
      "description": "Form Energy is developing a new class of cost-effective, multi-day energy storage systems that will enable a reliable, resilient, and fully renewable electric grid year-round. Our pioneering battery technology will entirely reshape the global electric system and give it new form.",
    ...
    },
    {
      "name": "Rondo Energy",
      "employees": 90,
      "description": "Rondo is delivering the world\\'s lowest cost zero-carbon industrial heat. The Rondo Heat Battery powers industrial processes with renewable electricity, cutting energy costs and eliminating emissions. We deliver complete solutions to large-scale industrial energy needs worldwide - both as major capital projects and on a Heat as a Service basis. The Rondo Heat Battery provides temperatures up to 1,500\u00b0C, at less than half the cost and twice the efficiency of hydrogen.",
      "website": "rondo.energy",
      "active_jobs": 0
    },
    {
      "name": "Antora Energy",
    ...
    },
    {
      "name": "Energy Dome",
      "employees": 39,
      "description": "Energy Dome is a company with revolutionary technology for large scale and long duration energy storage. Our proprietary technology is based on a thermodynamic process that uses CO2 to store electricity cost-effectively with unprecedented round trip efficiencies. The simplicity of the process as well as the use of readily available off-the-shelf equipment opens the way for Energy Dome to quickly become an important player in the energy storage market. With our technology it is possible to store large quantities of energy for long periods of time anywhere without any site dependency and deliver all the typical services of utility-scale storage systems, including grid regulation services, maximizing investment returns for our customers.",
      "website": "energydome.com",
      "active_jobs": 5
    },
    {
      "name": "Quidnet Energy",
      "employees": 20,
      "description": "Quidnet Energy is a technology-driven energy company that powers the carbon-free electric grid. Its technology is a form of hydroelectric energy storage using time-tested well-drilling and construction technologies to pump water under pressure into subsurface geological reservoirs to store energy. When variable renewable energy is not available, this water is released to drive hydroelectric turbines to power the electric grid. The company was founded in 2013 and is based in Houston with offices in San Francisco and Saratoga Springs, New York.",
      "website": "quidnetenergy.com",
      "active_jobs": 0
    },
    {
      "name": "Spire power solutions",
      "employees": 8,
      "description": "Spire Power Solutions brings together the industry\u2019s widest range of transformers and power solutions to deliver products, services, and support tailored for your success. With rapid response times and decades of operations and engineering expertise, we listen to \u2014 and meet \u2014 your needs when no one else can.",
      "website": "spirepowersolutions.com",
      "active_jobs": 43
    },
    {
      "name": "Office of Clean Energy Demonstrations",
      "employees": 1,
      "description": "OCED\u2019s mission is to deliver clean energy technology demonstration projects at scale in partnership with the private sector to accelerate deployment, market adoption, and the equitable transition to a decarbonized energy system.",
      "website": "",
      "active_jobs": 0
    }
  ],
  "Utility-Scale Solar Photovoltaics": [
    {
      ...
      "employees": 142,
      "description": "LevelTen Energy, Inc. manages a renewable energy transaction platform that connects corporate and industrial (C&amp;I) power buyers to the universe of power purchase agreements (PPAs) from utility-scale wind, solar, and storage projects. In facilitating these transactions, LevelTen aims to revolutionize the $30 billion C&amp;I power market and to mobilize untapped corporate clean power demand.",
    ...
    },
    {
      "name": "Fuse Energy",
      "employees": 39,
      "description": "Fuse is an energy supplier that offers the UK\\'s cheapest electricity tariff.",
  ...
  "Waste to Energy": [
    {
      "name": "Sierra Energy",
      "employees": 67,
      "description": "Since 2004, Sierra Energy has focused on the development of FastOx gasification, a technology that turns trash into energy without burning. This sustainable solution is commercially available to meet the needs of the modern waste industry. The company continues to advance its technology and test new applications for gasification at the Sierra Energy Research Park in Davis, California. Sierra Energy\u2019s commercial facility is located in Monterey County, California.",
      "website": "sierraenergy.com",
      "active_jobs": 0
    }
  ],
  ...
  "Water Distribution Efficiency": [
    ...
    },
    {
      "name": "Aquam",
      "employees": 47,
      "description": "Aquam Corp is a world-leading cleantech firm that provides infrastructure support, rehabilitation and diagnostics solutions. We are the first and only company to provide full service inside and outside infrastructure solutions for all markets around the world. For several decades, we have worked with the world\u2019s most prestigious companies to solve problems for their infrastructure systems and fluid distribution systems.",
      "website": "aquamcorp.com",
      "active_jobs": 0
    },
    {
      "name": "FREDsense",
      "employees": 24,
      "description": "FREDsense manufactures portable testing kits to detect water-borne chemicals and contaminants such as arsenic, iron, manganese, acidity. It monitors water quality through its product called FRED. FRED Sense also builds a custom, field-based solution for the parameters that its clients are interested in monitoring. David Lloyd, Emily Hicks, Iain George, Lisa Oberding, and Robert Mayall founded it in 2014, with its headquarters in Waterloo in Canada.",
      "website": "fredsense.com",
      "active_jobs": 2
    },
    {
      "name": "DigitalPaani",
